...
class FeatureExtraction:
    ...
    def PageRank(self):
        try:
            page_rank_checker_response = requests.post("https://www.checkpagerank.net/index.php", {"name": self.domain})

            global_rank = int(re.findall(r"Global Rank: ([0-9]+)", page_rank_checker_response.text)[0])
